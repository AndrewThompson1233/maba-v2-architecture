...
| Model Tier | Total Params | Core Params | Layers (DGDA : SA) | Hidden Dim (d) | Heads (H) | Head Dim (d_h) | Latent Dim (d_c) | Vocab Size | Embed Dim (d_emb) | Vocab Tax (%) |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
...
Standard autoregressive language models allocate 15% to 35% of total parameters to token embeddings when using vocabularies ≥ 128k. For example, a 256k vocabulary with d = 4096 requires over 1 billion parameters purely for embedding tables.
...
Given sequence length L, model hidden dimension d, total layers N, attention layers N_SA, latent dimension d_c, block size B = 64, and index dimension d_idx = 64:
...
2. **Bounded Attention Window**: The 5 MABA-SA layers evaluate attention strictly over:
   ...
   - Top-32 gathered centroid blocks (32 × 64 = 2,048 tokens).
...
| :--- | :---: | :---: | :---: | :--- |
| **Maba v2-30B** | **1.75 GB** | **3.5 MB active (1.20 GB total)** | **O(1) Flat** | **NoPE (Recurrent Decay α_t)** |
